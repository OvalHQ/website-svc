...
export const questions = [
  {
    ...
    answer:
      'You can send money from the United Kingdom, United States, Canada & Nigeria',
  },
  {
  ...
  },
  {
    ...
    answer: (
      <p>
        1. We're a licensed money transmitter and we’re licensed in and are
        regulated by the authorities in the countries we operate in. <br />
        2. We have a dedicated anti-fraud team. We work round the clock to keep
        your account and money protected from even the most sophisticated fraud.{' '}
        <br />
        3. We’re committed to keeping your personal data safe, and we’re
        transparent in how we collect, process, and store it.
      </p>
    ),
  },
];
