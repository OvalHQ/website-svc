...
export default function OvalPrivacyPolicy() {
  ...
  return (
    <>
      <Head>
        <title>Oval: Oval Terms of Service - Business</title>
      </Head>
      ...
      <main className="pt-8 px-12 bg-white min-h-screen md:overflow-x-hidden">
        <div className="w-4/5 mx-auto my-0 max-w-[700px] min-w-[300px]">
          <Legal active="oval-terms-of-service-business" />
          <h3 className="mb-4 text-center">Oval Terms of Service - Business</h3>
          <p className="mb-4">May 1, 2021</p>
          <p className="mb-4">
            Welcome to <a href="http://www.useoval.com">www.useoval.com</a> (the
            “Site”), a website of Oval Technologies LLC a Delaware corporation
            (“Oval” “we,” or “us”). This page explains the terms by which you
            may use the financial services we make available to you on our Site
            or on our mobile application (collectively the “Services”).
          </p>
          <p className="mb-4">
            ...
            (“Agreement”), Oval Account Agreement, Oval Card Agreement, the
            Deposit Account Agreements of the banking service provider for your
            account, other applicable terms and conditions referenced and
            incorporated in this Agreement, and to the collection and use of
            your information as set forth in the Oval Privacy Policy. You also
            agree to receive all notices and other communications from us
            electronically. Oval reserves the right to make unilateral
            modifications to these terms and will provide notice of these
            changes by posting an updated version to our legal page.
          </p>
          <p className="mb-4">
            “Company” or “You” means the legal entity that is applying for or
            that has opened an Account to use the Services and the individual
            applying for the Account. If you are the individual applying for the
            Account for a business, you represent and warrant that you are an
            authorized representative of Company with the authority to bind
            Company to this Agreement, and that you agree to this Agreement on
            Company’s behalf.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            Services for business purposes, if you are a legal entity formed and
            registered in the United States and can form a binding contract with
            Oval and only in compliance with this Agreement and all applicable
            local, state, national, and international laws, rules and
            regulations. Any use of or access to the Services for consumer or
            non-commercial purposes, by anyone under 18 is strictly prohibited
            and in violation of this Agreement. There may be other eligibility
            requirements applicable to specific Services.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            provide Company information and certain personal information
            (collectively, “Company Information”), when you apply for an Account
            for business purposes. Company Information may include your
            registered business name and state of incorporation, the business
            address, ownership details, the nature of the business, and other
            business information we may request from time to time; the name,
            contact information, and date of birth of beneficial owners and
            certain other personnel, and other personal information; and a
            corporate registration certificate, proof of address, personal
            identification, and any other documentary information used to verify
            business and personal information. We provide Company Information to
            our Banking Services Provider and other third-party service
            providers to determine your eligibility for the Services. We rely on
            the accuracy of the Company Information you provide us when opening
            and maintaining your Account. We may deny your applications, suspend
            provision of the Services to you, or close your Account if Company
            Information is out of date, incomplete, or inaccurate. At any time
            during the term of this Agreement and as part of your use of the
            Services, we may require additional Company Information from you to
            verify your identity and the identity of your business, to obtain
            other information about your business, to open and maintain accounts
            and aspects of the Services, to assess your financial condition, and
            to evaluate the risks associated with your business. You expressly
            consent and authorize us to retrieve additional Company Information
            about Company and its owners or directors from our vendors and other
            ...
            authorize and direct such third parties to compile and provide such
            ...
            may use Company Information to verify any other information you
          ...
          <p className="mb-4">
            ...
            Agreement; (b) for any personal, family, household, or other use
            that is not related to Company’s business purpose in case of a
            business Account; (c) for the benefit of an individual,
            organization, or country identified on the United States Office of
            Foreign Assets Control’s Specially Designated Nationals List, or (d)
            for any third parties unaffiliated with Company.
          </p>
          <p className="mb-4">
            F. <strong>Acceptable Use</strong>. By registering for and using the
            ...
            funds for any third party; or (iii) to conduct any of the restricted
            business activities or practices listed here:
          </p>
          <ul className="mb-4 list-disc">
            <li>Any illegal activity, goods, or services</li>
            <li>
              Money and legal services (including financial institutions, money
              transmission, prepaid cards, check cashing, wire transfers, money
              orders, currency exchanges or dealers, credit counseling services,
              bill pay services, crowdfunding, insurance, bail bonds, or
              collections agencies or collections attorneys)
            </li>
            <li>
              Buyer or membership clubs, including dues associated with such
              clubs
            </li>
            <li>Credit protection or identity theft protection services</li>
            <li>
              Direct marketing or subscription offers or services or
              unauthorized multi-level marketing businesses
            </li>
            <li>Infomercial sales</li>
            <li>
              Internet/mail order/telephone order pharmacies or pharmacy
              referral services (where fulfillment of medication is performed
              with an Internet or telephone consultation, absent a physical
              visit with a physician including re-importation of pharmaceuticals
            ...
            <li>
              Betting, including lottery tickets, casino gaming chips, Fantasy
              Football, off-track betting, and wagers at races
            </li>
            ...
            <li>
              ...
              including Internet, telephone or printed material)
            </li>
            <li>
              Sales of (i) firearms, firearm parts or hardware, and ammunition;
              or (ii) weapons and other devices designed to cause physical
              injury
            </li>
          ...
          <p className="mb-4">
            ...
            enforcing this section will be at our sole discretion. We may, at
            our discretion, permit businesses that conduct any of the activities
            above to use the Services with restrictions as determined by us.
            Oval may modify this section at any time by posting a revised
            version in this Agreement.
          </p>
          ...
          <p className="mb-4">
            B. <strong>Oval Virtual and Physical Cards</strong>. <br />
            ...
            for your business using funds in your Oval Deposit Account. You may
            not use the Oval Cards for any non-business purpose, such as for
          ...
          <p className="mb-4">
            ...
            sign up for a Oval Deposit Account for your business, you will be
            issued one physical Oval Card. You may request additional virtual
            and physical Oval Cards for your employees, contractors, or other
            people affiliated with your business.
          </p>
          <p className="mb-4">
            (ii) <strong>Spending Limits, Payments, and Refunds</strong>.
            Spending on your Oval Card(s) is limited by the available funds in
            your Deposit Account. Your Oval Card transactions will be settled as
            they occur by debiting your Oval Deposit Account an amount equal to
            each Oval Card transaction. Refunds to your Oval Card will be
            applied to your Oval Deposit Account. If you use your Oval Card for
            preauthorized, recurring, or subscription payments, you should
            regularly monitor the available funds in your Deposit Account to
            ensure that funds are available to make those payments. If funds are
            not available at the time a preauthorized, recurring or subscription
            payment is attempted on your Oval Card, the transaction will
            ordinarily be declined. We will generally decline transactions
            attempted on your Oval Card that would overdraw your Deposit
            Account. If, however, we do not decline a transaction and that
            transaction does overdraw your account, we may limit your ability to
            use other features or spend additional funds from your Deposit
            Account until your Deposit Account has a positive balance and the
            transaction that has overdrawn your account has been paid. For more
            information related to the manner in which your Oval Card
            transactions are debited and settled, refer to the Oval Card
            Agreement.
          </p>
          <p className="mb-4">
            (iv) <strong>Disputes</strong>. If you have a dispute about a
            purchase on your Oval Card that you cannot resolve with the merchant
            directly (a “Disputed Charge”), please contact us at
            ...
            determine you should be reimbursed, we will credit the amount of the
            Disputed Charge back to your Deposit Account and you will not be
            charged any fees. If we determine that the Disputed Charge was
            valid, your Deposit Account will not be reimbursed, and you will be
            charged a fee as set forth in the Fee Schedule. You assign and
            transfer to us any rights and claims, excluding tort claims, that
            you have against a merchant for any Disputed Charge that is fully or
            partially credited to your Deposit Account. We may assign and
            transfer the rights you assign and transfer to us under this
            provision to the Oval Card Issuer.
          </p>
          <p className="mb-4">
            (v) <strong>Records, Fees, and Communication</strong>. All
            transaction records and periodic statements may be found in your
            dashboard for your Account. All fees associated with the Oval Cards
            may be found in the Oval Card Agreement.
          </p>
          <p className="mb-4">
            (vi) <strong>Other Oval Card Terms</strong>. Oval Cards are issued
            by Evolve Bank & Trust (the “Issuer.” ) You agree to the applicable
            Evolve Bank & Trust terms and conditions. You agree that any future
            changes to the relevant Evolve Bank & Trust terms and conditions
            will apply to your Oval Card, whether or not Oval or Evolve Bank &
            Trust alerts you to those changes to the Evolve terms and
            conditions.
          </p>
          <p className="mb-4">
            C. <strong>Mobile Remote Deposit Capture</strong>. You may remotely
            ...
            payable to you as the business entity that is named on the Deposit
            Account. We reserve the right to reject any Mobile Deposit for any
            reason.
          </p>
          <p className="mb-4">
            (i) <strong>Depositing your Check</strong>. You are responsible for
            creating an accurate Mobile Deposit. To deposit your check, you must
            endorse the check, enter the correct amount of the check (you are
            liable for any errors you make during the deposit process), create a
            check image using the camera on your mobile device to take a picture
            of the front and back of your check. You may only deposit eligible
            items through the mobile remote deposit capture service. To mitigate
            the risk of fraud or the presentment of duplicate items, you agree
            to mark on the original paper check that the item has been deposited
            electronically. You also agree to retain all checks deposited via
            mobile remote deposit capture for at least two business days after
            the deposit is made and to destroy all deposited checks as soon as
            reasonably possible, and in no event later than 30 days after the
            deposit.
          </p>
          <p className="mb-4">
            (ii) <strong>Returned Items</strong>. You acknowledge and agree that
            we may charge you any fees associated with a returned item if a
            check is returned to us for any reason.
          </p>
          <p className="mb-4">
            ...
            representation or warranty that would have applied had you deposited
            the original paper check. This includes representations and
            warranties we make on your behalf when we transfer, present, or
            originate the Mobile Deposit created from your check image. These
            representations and warranties include but are not limited to, that:
            (a) the transmissions contain accurate images of the front and back
            of the original checks; (b) the transmissions contain all necessary
            endorsements; and (c) no depository bank, drawee, drawer, or
            endorser will be asked to make a payment based on an item that it
            has already paid.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            Oval Technologies LLC,8 The Green, Suite #6880, Dover Delaware 19901
          </p>
          <p className="mb-4">
          ...
          <p className="mb-">
            ...
            collection, use and disclosure of Company Information and aggregate
            data we collect from your use of the Services (“Site Data”) as set
            forth in our Privacy Policy, and to have Company Information and
            ...
            safeguards to preserve the integrity and security of your Company
            ...
            defeat our security measures or use Company Information for improper
            purposes. You acknowledge that you provide Company Information at
            your own risk. Your use of the Deposit Account and other financial
            services is subject to the privacy policies of our Banking Services
            Provider.
          </p>
          ...
          <p className="mb-4">
            ...
            OF THE SERVICES. Oval DOES NOT WARRANT, ENDORSE, GUARANTEE, OR
            ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR
            OFFERED BY A THIRD PARTY THROUGH THE SERVICES OR ANY HYPERLINKED
            WEBSITE OR SERVICE, AND Oval WILL NOT BE A PARTY TO OR IN ANY WAY
          ...
          <p className="mb-4">
            ...
            BY APPLICABLE LAW, Oval ASSUMES NO LIABILITY OR RESPONSIBILITY FOR
            ANY (I) ERRORS, MISTAKES, OR INACCURACIES OF CONTENT; (II) PERSONAL
            INJURY OR PROPERTY DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM
            YOUR ACCESS TO OR USE OF OUR SERVICES; (III) ANY UNAUTHORIZED ACCESS
            ...
            SERVICES BY ANY THIRD PARTY; (VI) ANY ERRORS OR OMISSIONS IN ANY
            ...
            AVAILABLE THROUGH THE SERVICES; AND/OR (VII) USER CONTENT OR THE
            DEFAMATORY, OFFENSIVE, OR ILLEGAL CONDUCT OF ANY THIRD PARTY. IN NO
            EVENT SHALL Oval, ITS AFFILIATES, AGENTS, DIRECTORS, EMPLOYEES,
            SUPPLIERS, OR LICENSORS BE LIABLE TO YOU FOR ANY CLAIMS,
            PROCEEDINGS, LIABILITIES, OBLIGATIONS, DAMAGES, LOSSES OR COSTS IN
            AN AMOUNT EXCEEDING $100.00. THIS LIMITATION OF LIABILITY SECTION
            APPLIES WHETHER THE ALLEGED LIABILITY IS BASED ON CONTRACT, TORT,
            NEGLIGENCE, STRICT LIABILITY, OROLID ANY OTHER BASIS, EVEN IF Oval
            HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGE. THE FOREGOING
          ...
          <p className="mb-4">
            B. <strong>Governing Law</strong>. READ THIS SECTION CAREFULLY
            BECAUSE IT REQUIRES THE PARTIES TO ARBITRATE THEIR DISPUTES AND
            LIMITS THE MANNER IN WHICH YOU CAN SEEK RELIEF FROM Oval. For any
            dispute with Oval, you agree to first contact us at 2631 plantation
            hollow ct missouri city tx 77459 and attempt to resolve the dispute
            with us informally. In the unlikely event that Oval has not been
            able to resolve a dispute it has with you after sixty (60) days, we
            each agree to resolve any claim, dispute, or controversy (excluding
            any claims arising from protection of Intellectual Property Rights,
            ...
            arbitration will be conducted in San Francisco County, California,
            unless you and Oval agree otherwise. If JAMS cannot administer the
            Claim, either party may petition the US District Court for Delaware
            to appoint an arbitrator. Each party will be responsible for paying
            ...
            competent jurisdiction. Either party may commence arbitration by
            providing a written demand for arbitration to JAMS and the other
            party detailing the subject of the Claim and the relief requested.
            Each party will continue to perform its obligations under this
            Agreement unless that obligation or the amount (to the extent in
            dispute) is itself the subject of the Claim. Nothing in this Section
            shall be deemed as preventing either party from seeking injunctive
            or other equitable relief from the courts as necessary to prevent
            the actual or threatened infringement, misappropriation, or
            violation of our data security, Intellectual Property Rights or
            other proprietary rights. Proceedings and information related to
            them will be maintained as confidential, including the nature and
            details of the Claim, evidence produced, testimony given, and the
            outcome of the Claim, unless such information was already in the
            public domain or was independently obtained. Company and Oval, and
            all witnesses, advisors, and arbitrators will only share such
            information as necessary to prepare for or conduct arbitration or
            other legal proceeding, or enforcement of the outcome, unless
          ...
          <p className="mb-4">
            ...
            reasonably ensures we receive your revocation. By providing us with
            a telephone number, you agree that Oval may record any telephone
            conversation with you (or any another individual) during any
            telephone call to or from that number for training purposes, whether
            or not the call was initiated by you, and whether or Oval disclosed
            the fact that the call was recorded during the call.
          </p>
          <h3 className="mb-4">13. General</h3>
          <p className="mb-4">A. <strong>Assignment</strong>. This Agreement, and any rights and licenses granted hereunder, may not be transferred or assigned by you, but may be assigned by Oval without restriction. Any attempted transfer or assignment in violation hereof shall be null and void.
</p><p className="mb-4">B. <strong>Notification Procedures and Changes to the Agreement</strong>. You consent to us providing notices to you under this Agreement electronically and understand that this consent has the same legal effect as a physical signature. We will provide notices to you electronically through your Account, and via text or SMS to the phone numbers provided to us by you. If you sign up to receive certain Oval notifications or information via text or SMS, you may incur additional charges from your wireless provider for these notices. You agree that you are solely responsible for any such charges. Notices affecting the terms of this Agreement will be sent to you and are considered received 24 hours after they are sent. You understand that you may not use the Services unless you consent to receive notices from us electronically. You may only withdraw consent to receive notices electronically by closing your Account. Notices may include alerts about the Services, your Account, and your Deposit Account and may provide you the ability to respond with information about Deposit Account transactions or your Account. You may disable notification preferences to limit the use of certain Service features or to decrease financial risks to the Company. You are required to maintain a regularly updated web browser, and computer and mobile device operating systems to receive notices correctly. You will be responsible for all costs imposed by internet or mobile service providers for sending or receiving notices electronically. Contact us immediately at info@useoval.com if you are having trouble receiving notices from us.
</p><p className="mb-4">C. <strong>Entire Agreement/Severability</strong>. This Agreement, together with any amendments and any additional agreements you may enter into with Oval in connection with the Services, shall constitute the entire agreement between you and Oval concerning your Account and the Services. If any provision of this Agreement is deemed invalid by a court of competent jurisdiction, the invalidity of such provision shall not affect the validity of the remaining provisions of this Agreement, which shall remain in full force and effect, except that in the event of unenforceability of the universal Class Action/Jury Trial Waiver, the entire arbitration agreement shall be unenforceable.
</p><p className="mb-4">D. <strong>No Waiver</strong>. No waiver of any term of this Agreement shall be deemed a further or continuing waiver of such term or any other term, and Oval’s failure to assert any right or provision under this Agreement shall not constitute a waiver of such right or provision.
</p><p className="mb-4">E. <strong>Legal Orders</strong>. We may respond to and comply with any subpoenas, warrants, liens, or any other legal order we receive related to your use of the Services. We are not responsible to you for any losses you incur due to our response to such legal order. We may hold funds or provide information as required by the issuer of the legal order or take any other actions we believe are required of us under legal orders. Where permitted, we will provide you reasonable notice that we have received such an order.
</p><p className="mb-4">F. <strong>Survival</strong>. Any and all provisions of this Agreement reasonably giving rise to continued obligations of the parties will survive termination of this Agreement.
</p><p className="mb-4">G. <strong>Relationship</strong>. No joint venture, partnership, employment, or agency relationship exists between you and Oval as a result of this Agreement or your use of the Site.
</p>
        </div>
      </main>
      <Footer />
